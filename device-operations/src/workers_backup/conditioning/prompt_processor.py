"""
Advanced prompt processing for SDXL models.
Handles prompt weighting, attention manipulation, and multi-prompt composition.
"""
...
class PromptProcessor:
    """Advanced prompt processor for SDXL inference."""
    
    def __init__(self):
        self.max_prompt_length = 77  # Standard CLIP limit
