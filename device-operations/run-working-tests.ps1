# PowerShell script to run only the tests we fixed
...
try {
    Write-Host "Running working tests..." -ForegroundColor Green
    dotnet test DeviceOperations.csproj --verbosity normal
